...
_FAKE_LLM_OUTPUT = {
    ...
    "chat_flow": [
        {"stage": "opening_statement", "followed": False, "note": "No greeting."},
        {"stage": "acknowledgement_empathy", "followed": False, "note": "Acknowledged but curt."},
        {"stage": "probing_verification", "followed": True, "note": "Asked for the tag number."},
        {"stage": "solution_discussion_agreement", "followed": False, "note": "No options discussed."},
        {"stage": "resolution", "followed": True, "note": "Filed report, gave reference BAG-1."},
        {"stage": "further_assistance", "followed": False, "note": "Never asked if anything else was needed."},
        {"stage": "closing_statement", "followed": False, "note": "No closing statement."},
    ],
    "resolved": True,
